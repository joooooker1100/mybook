...
function Users() {
    ...
    <div>
      ...
      >
        ...
        <input type={"text"} value={user.lastName} placeholder={"lastName"} onChange={(e)=>{setUser({...user,lastName:e.target.value})}} />
        <input type={"text"} value={user.codeMeli} placeholder={"codeMeli"} onChange={(e)=>{setUser({...user,codeMeli:e.target.value})}} />
        <input type={"text"} value={user.mobile} placeholder={"mobile"} onChange={(e)=>{setUser({...user,mobile:e.target.value})}} />
        <input type={"text"} value={user.exp} placeholder={"EXP"} onChange={(e)=>{setUser({...user,exp:e.target.value})}} />
        <button onClick={()=>{
            if (
            ...
            setUser({name:"",lastName:"",codeMeli:"",mobile:"",exp:""})           
        }}>Save</button>
